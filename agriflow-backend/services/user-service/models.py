from sqlalchemy import Column, String, Integer, Boolean, Float, Text, Enum, DateTime, ForeignKey
...
class FarmerProfile(Base):
    ...
    primary_commodities = Column(ARRAY(Text))
    has_insurance = Column(Boolean, default=False)
    credit_score = Column(Integer, default=300)
    bank_account = Column(JSONB) # Encrypted string usually
